...
-- -------------------------------------------------------------------------------------
ALTER TABLE [COMDATA_EVENTOS].[EVENTOS_DETALHE]  WITH CHECK ADD  CONSTRAINT [CK_EVENTOS_DETALHE_MES_DIA] CHECK  (([MES_DIA] like '[0-1][0-9]/[0-3][0-9]'))
GO
ALTER TABLE [COMDATA_EVENTOS].[EVENTOS_DETALHE] CHECK CONSTRAINT [CK_EVENTOS_DETALHE_MES_DIA]
GO
